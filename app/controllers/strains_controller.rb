class StrainsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @strain.save
        format.html { redirect_to @strain, notice: "Cepa creada." }
  ...
  def update
    respond_to do |format|
      if @strain.update(strain_params)
        format.html { redirect_to @strain, notice: "Cepa ingresada." }
  ...
  def destroy
    @strain.destroy
    respond_to do |format|
      format.html { redirect_to strains_url, notice: "Cepa eliminada." }
