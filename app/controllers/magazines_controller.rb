class MagazinesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @magazine.save
        format.html { redirect_to @magazine, notice: "Revista creada exitosamente." }
  ...
  def update
    respond_to do |format|
      if @magazine.update(magazine_params)
        format.html { redirect_to @magazine, notice: "Revista ingresada exitosamente." }
  ...
  def destroy
    @magazine.destroy
    respond_to do |format|
      format.html { redirect_to magazines_url, notice: "Revista eliminada." }
  ...
  private
    ...
    def magazine_params
      params.require(:magazine).permit(:name, enologist_magazines_attribute: [:id, :editor, :writer, :reviewer, :enologist_id, :_destroy])
    end
end
